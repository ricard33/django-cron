...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('django_cron_job', (
            ...
            ('last_run', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 5, 4, 17, 49, 5, 639000))),
    ...
    models = {
        ...
        'django_cron.job': {
            ...
            'last_run': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 5, 4, 17, 49, 5, 639000)'}),
